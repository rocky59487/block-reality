...
| Java tests | 713/713 registered (latest Windows run: 673 pass, 40 legacy skips including 28 legacy sidecar cases without br.sidecar); 28 start the real sidecar and FrameCore, 42 cover in-process BSI engine integration |
