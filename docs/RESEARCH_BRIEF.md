...
| Java tests | 622/622 registered (Windows coverage: 610 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
