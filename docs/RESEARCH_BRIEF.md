...
| Java tests | 528/528 registered (latest Windows run: 516 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
