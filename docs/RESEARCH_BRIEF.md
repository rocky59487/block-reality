...
| Java tests | 639/639 registered (Windows coverage: 627 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
