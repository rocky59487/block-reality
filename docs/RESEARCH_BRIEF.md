...
|---|---|
| Engine checks | 151/151 passing; each uses a closed form or solver-independent invariant |
| Java tests | 107/107 passing; 26 start the real sidecar and FrameCore |
