...
| Java tests | 609/609 registered (latest Windows run: 597 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
