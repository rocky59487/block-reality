...
| Java tests | 647/647 registered (latest Windows run: 606 pass, 41 skips including 28 legacy sidecar cases without br.sidecar); 28 start the real sidecar and FrameCore, 42 cover in-process BSI engine integration |
