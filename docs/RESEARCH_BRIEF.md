...
| Java tests | 614/614 registered (Windows coverage: 602 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
