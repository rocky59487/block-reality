...
| Java tests | 596/596 registered (latest Windows run: 584 pass, 12 platform skips); 28 start the real sidecar and FrameCore, 20 cover in-process BSI engine integration |
