...
- **誠實邊界寫在信裡**(彈性、線性挫屈只到起始點、共線 run 是單一元素所以自重主宰時
  低報 68%、無 RC 複合)——內行人第一眼就會戳這裡,你先說,信用就是你的
- 三個具體問題,不要開放式的「您覺得如何」
- 學生身分是資產不是弱點,寫明
...
>
> The part I hope earns your 30 minutes: the verification record. 330 acceptance
...
>
> The engineering is verified (41 closed-form acceptance checks in a 330-check suite per build, record in
