...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_713_Java_checks_registered-blue)
...
| Java | 713 tests registered (561 core, 152 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 42 cover in-process BSI engine integration |
...
| Java | 713 項測試已登錄（core 561、Forge 側 152），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 42 項涵蓋 BSI 程序內引擎整合 |
