...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_414_Java_checks_registered-blue)
...
| Java | 414 tests registered (334 core, 80 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 15 load the BSI engine library in-process |
...
| Java | 414 項測試已登錄（core 334、Forge 側 80），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 15 項在同一個程序內載入 BSI 引擎函式庫 |
