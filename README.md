...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_647_Java_checks_registered-blue)
...
| Java | 647 tests registered (523 core, 124 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 42 cover in-process BSI engine integration |
...
| Java | 647 項測試已登錄（core 523、Forge 側 124），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 42 項涵蓋 BSI 程序內引擎整合 |
