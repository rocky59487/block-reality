...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_420_Java_checks_registered-blue)
...
| Java | 420 tests registered (339 core, 81 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 16 cover in-process BSI engine integration |
...
| Java | 420 項測試已登錄（core 339、Forge 側 81），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 16 項涵蓋 BSI 程序內引擎整合 |
