...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_603_Java_checks_registered-blue)
...
| Java | 603 tests registered (472 core, 131 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 20 cover in-process BSI engine integration |
...
| Java | 603 項測試已登錄（core 472、Forge 側 131），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 20 項涵蓋 BSI 程序內引擎整合 |
