...
| Java | 215 tests, all passing (179 pure-Java, 36 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real |
...
| Java | 215 項測試全過（純 Java 179、Forge 側 36），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore |
