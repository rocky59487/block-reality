...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_555_Java_checks_registered-blue)
...
| Java | 555 tests registered (446 core, 109 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 20 cover in-process BSI engine integration |
...
| Java | 555 項測試已登錄（core 446、Forge 側 109），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 20 項涵蓋 BSI 程序內引擎整合 |
