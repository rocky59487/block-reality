...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_622_Java_checks_registered-blue)
...
| Java | 622 tests registered (477 core, 145 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 20 cover in-process BSI engine integration |
...
| Java | 622 項測試已登錄（core 477、Forge 側 145），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 20 項涵蓋 BSI 程序內引擎整合 |
