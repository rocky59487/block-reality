...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_517_Java_checks_registered-blue)
...
| Java | 517 tests registered (410 core, 107 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 19 cover in-process BSI engine integration |
...
| Java | 517 項測試已登錄（core 410、Forge 側 107），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 19 項涵蓋 BSI 程序內引擎整合 |
