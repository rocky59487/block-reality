...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_413_Java_checks_registered-blue)
...
| Java | 413 tests registered (332 core, 81 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 14 cover in-process engine integration |
...
| Java | 413 項測試已登錄（core 332、Forge 側 81），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 14 項涵蓋 v0.4 的程序內引擎整合 |
