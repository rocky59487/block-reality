...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_313_Java_checks-passing)
...
| Java | 313 tests, all passing (260 pure-Java, 53 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 4 more load the v0.4 engine library in-process |
...
| Java | 313 項測試全過（純 Java 260、Forge 側 53），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 4 項在同一個程序內載入 v0.4 的引擎函式庫 |
