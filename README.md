...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_347_Java_checks_registered-blue)
...
| Java | 347 tests registered (290 core, 57 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 10 load the v0.4 engine library in-process |
...
| Java | 347 項測試已登錄（core 290、Forge 側 57），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 10 項在同一個程序內載入 v0.4 的引擎函式庫 |
