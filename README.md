...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_268_Java_checks-passing)
...
| Java | 268 tests, all passing (217 pure-Java, 51 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real |
...
| Java | 268 項測試全過（純 Java 217、Forge 側 51），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore |
