...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_340_Java_checks-passing)
...
| Java | 340 tests registered (260 pure-Java, 53 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 4 more load the v0.4 engine library in-process |
...
| Java | 340 項測試已登錄（純 Java 260、Forge 側 53），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 4 項在同一個程序內載入 v0.4 的引擎函式庫 |
...
Java 總數包含環境 SKIP；本輪 Windows core 283=271PASS/12SKIP，Forge57PASS，真原生JNA9/9。BSI 遊戲入口仍未換裝。詳見 docs/GATES.md 2026-09-08。
