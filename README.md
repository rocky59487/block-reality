...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_487_Java_checks_registered-blue)
...
| Java | 487 tests registered (383 core, 104 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 18 cover in-process BSI engine integration |
...
| Java | 487 項測試已登錄（core 383、Forge 側 104），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 18 項涵蓋 BSI 程序內引擎整合 |
