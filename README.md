...
![Verification](https://img.shields.io/badge/verification-330_engine_%2B_396_Java_checks_registered-blue)
...
| Java | 396 tests registered (305 core, 64 Forge-side); 28 of them start `br-sidecar` and run FrameCore for real, and 12 load the v0.4 engine library in-process |
...
| Java | 396 項測試已登錄（core 305、Forge 側 64），其中 28 項會實際啟動 `br-sidecar` 執行 FrameCore，另有 12 項在同一個程序內載入 v0.4 的引擎函式庫 |
