...
#pragma once
#if (defined(BSI_TEST_NPD_MAPPING) || defined(BSI_TEST_NPD_QUALIFICATION) || defined(BSI_TEST_NPD_ATOMIC)) && !defined(BSI_HOST_TEST_MUTATIONS)
#error "NPD host mutation requires BSI_HOST_TEST_MUTATIONS"
#endif
