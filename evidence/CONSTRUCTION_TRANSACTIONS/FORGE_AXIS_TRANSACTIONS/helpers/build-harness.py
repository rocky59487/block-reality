...
root=Path('/home/rocky/br-forge-axis-transactions');source=Path('/mnt/c/Users/wmc02/Desktop/block-reality/build/forge-axis-transactions/harness')
...
(out/'harness-build-first-exit.json').write_text(json.dumps({'exit':result.returncode,'command':command}));print('harness',result.returncode,flush=True)
