...
root=Path('/home/rocky/br-bounded-chunk-read');source=Path('/mnt/c/Users/wmc02/Desktop/block-reality/build/bounded-chunk-read/harness')
...
jar=dest/'build/libs/br-chunk-probe-1.0.jar'
with zipfile.ZipFile(jar) as z:
    names=z.namelist();assert 'META-INF/mods.toml' in names and 'META-INF/accesstransformer.cfg' not in names
    assert all(n.startswith('com/blockreality/testchunkprobe/') for n in names if n.endswith('.class'))
