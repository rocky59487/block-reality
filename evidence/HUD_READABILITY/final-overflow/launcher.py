...
with (out/'client-first.log').open('w') as log:
 process=subprocess.Popen(command,cwd='/home/rocky/br-hud-readability-final-overflow-client/forge',env=env,stdout=log,stderr=subprocess.STDOUT,start_new_session=True)
