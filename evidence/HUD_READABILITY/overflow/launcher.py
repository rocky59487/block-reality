...
root=Path('/home/rocky/br-render-tools');out=Path('/home/rocky/br-hud-readability-overflow');env=os.environ.copy()
...
with (out/'client-first.log').open('w') as log:
 process=subprocess.Popen(command,cwd='/home/rocky/br-hud-readability-client/forge',env=env,stdout=log,stderr=subprocess.STDOUT,start_new_session=True)
