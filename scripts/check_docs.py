...
TABLE = [
    ("docs/history/README-pre-alpha.md", r"`sidecar/verify\.py`, (\d+) checks, all passing", "ENGINE"),
    ("docs/history/README-pre-alpha.md", r"`sidecar/verify\.py` (\d+) 項全過", "ENGINE"),
    ("docs/history/README-pre-alpha.md", r"\| Java \| (\d+) tests registered", "JAVA_TOTAL"),
    ("docs/history/README-pre-alpha.md", r"\| Java \| (\d+) 項測試已登錄", "JAVA_TOTAL"),
    ("docs/history/README-pre-alpha.md", r"(\d+) of them start `br-sidecar`", "JAVA_ENGINE"),
    ("docs/history/README-pre-alpha.md", r"其中 (\d+) 項會實際啟動 `br-sidecar`", "JAVA_ENGINE"),
    ("docs/history/README-pre-alpha.md", r"verification-(\d+)_engine", "ENGINE"),
    ("docs/history/README-pre-alpha.md", r"engine_%2B_(\d+)_Java_checks", "JAVA_TOTAL"),
    ("docs/history/QUICKSTART-pre-alpha.md", r"`ALL PASS`（(\d+) 項", "ENGINE"),
    ("docs/history/QUICKSTART-pre-alpha.md", r"其中 (\d+) 個會\*\*實際啟動", "JAVA_ENGINE"),
    ("docs/history/QUICKSTART-pre-alpha.md", r"沒帶 `-Dbr\.sidecar` 這 (\d+) 個會 skip", "JAVA_ENGINE"),
    ("docs/history/QUICKSTART-pre-alpha.md", r"資料層另外被 (\d+) 個測試釘住", "JAVA_TOTAL"),
    ("docs/RESEARCH_BRIEF.md", r"\| Engine checks \| (\d+)/\d+ passing", "ENGINE"),
    ("docs/RESEARCH_BRIEF.md", r"\| Engine checks \| \d+/(\d+) passing", "ENGINE"),
    ("docs/RESEARCH_BRIEF.md", r"\| Java tests \| (\d+)/\d+ registered", "JAVA_TOTAL"),
    ("docs/RESEARCH_BRIEF.md", r"\| Java tests \| \d+/(\d+) registered", "JAVA_TOTAL"),
...
FORBIDDEN = [
    ...
    ("docs/history/README-pre-alpha.md", r"byte-reproducible[^.]*another machine",
